...
do {
    ...
    switch (option) {
        ...
        case 2:
            ...
            break;
        case 3:
            const planetName = prompt('Digite o nome do planeta que você deseja alterar a situação');
            ...
            break;
        case 4:
            const planetsName = prompt('Digite o nome do planeta que você deseja alterar a situação');
